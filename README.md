...
**Note: You need to create a database and name it gameserver then import gameserver.sql to the database. Also, after downloading the file for the source code, change the filename to game and add it to htdocs.** <br><br>
Gameplay gif
<div align="center">
